 ...
 */
public abstract class LibvirtEngineMessage implements EventMessage {
     ...
     */
    public static LibvirtEngineMessage create(EngineEvent engineEvent) throws IllegalArgumentException {
    ...
    protected LibvirtEngineMessage(String connectIn, Optional<String> minionIdIn,
            String timestampIn) {
